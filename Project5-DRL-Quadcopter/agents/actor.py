...
class Actor():
    ...
    def build_model(self):
        ...
        # Add hidden layers
        net = layers.Dense(units=256, kernel_regularizer=layers.regularizers.l2(reg_term))(states)
        net = layers.BatchNormalization()(net)
        net = layers.Activation("relu")(net)
        
        net = layers.Dense(units=512, kernel_regularizer=layers.regularizers.l2(reg_term))(net)
        net = layers.BatchNormalization()(net)
        net = layers.Activation("relu")(net)
        
        net = layers.Dense(units=256, kernel_regularizer=layers.regularizers.l2(reg_term))(net)
        net = layers.BatchNormalization()(net)
        net = layers.Activation("relu")(net)
